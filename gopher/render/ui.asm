...
header db "   Moon Rabbit UNAPI Gopher browser for MSX 2 (c) 2021 Alexander Nihirash",13,0
toolbox db " [D]omain: ", 0
footer db "Up/Dn - select row  Left/right - page up/down  [B]ack to prev. page ESC - Quit", 0
